...
const zhCN = {
  ...
  settings: {
    ...
    doubleClickPasteDesc: '开启后，双击剪贴板历史记录项将自动粘贴到当前活动窗口',
    interface: '界面设置',
    pageSize: '每页显示数量',
...
const frFR = {
  ...
  settings: {
    ...
    doubleClickPasteDesc: 'Lorsqu\'il est activé, double-cliquer sur un élément de l\'historique du presse-papiers le collera automatiquement dans la fenêtre actuellement active',
...
const arSA = {
  ...
  settings: {
    ...
    doubleClickPasteDesc: 'عند التمكين، سيؤدي النقر المزدوج على عنصر سجل الحافظة إلى لصقه تلقائياً في النافذة النشطة حالياً',
